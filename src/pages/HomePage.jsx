...
function HomePage() {
    return (
        <>
            <main>
                <section className="w-full bg-Primary-50 overflow-x-hidden">
                ...
                <section className={`w-full bg-Primary-100 ${home_service_bg} `}>
                    <div className="max-w-[1296px] mx-auto px-4 pt-20 pb-10 xl:pt-30 ">
                        ...
                        <div className=" mb-10 flex flex-col items-center">
                            ...
                            <a
                                href="#"
                                className="inline-flex items-center justify-center gap-2 rounded-md bg-Primary-900 px-4 py-2 xl:py-4 xl:px-8 fs-6 xl:fs-5 text-Primary-50 hover:scale-110">
                                詳細內容與合作流程
                ...
                <section>
                    ...
                    <div className="max-w-[1296px] mx-auto px-3 pt-10 pb-10 xl:pt-20 ">
                        ...
                        <div className=" grid grid-cols-1 gap-6 pb-10 xl:pb-20
