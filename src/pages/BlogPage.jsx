  ...
  return (
    <>
      <main className="w-full mx-auto pt-10 pb-20 flex flex-col items-center justify-center gap-10">
        ...
        <ul className="w-full flex items-center gap-8 px-3 py-5 overflow-x-auto whitespace-nowrap [scrollbar-width:none] bg-Primary-100 sticky top-14 sm:top-24 md:top-24 z-20 lg:hidden">
          {tagList.map((tag) => (
            <li
